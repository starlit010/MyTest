...
<<<<<<< HEAD:src/main/java/com/grayliu/jdk/lang/ArraysTest.java
 * <p>
 * 1）Arrays.asList 不接受基本数据类型
 * <p>
=======
 *
 * 1）Arrays.asList 不接受基本数据类型（int[]，long[]，char[]，这些类型会被认为是一个array对象）
 *
>>>>>>> f621b29f30389358b7c0628c31e0950a5078b0e7:Java/src/main/java/com/grayliu/jdk/lang/ArraysTest.java
